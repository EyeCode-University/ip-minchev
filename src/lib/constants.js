...
export const COMPANY = {
  ...
  // Почтовый адрес на публичных страницах намеренно не публикуется: приём
  // заявок идёт через форму, телефон и email, а физический адрес остаётся
  // только в правовых документах (см. OPERATOR в src/lib/privacy.js), где
  // его требует Федеральный закон № 152-ФЗ.
